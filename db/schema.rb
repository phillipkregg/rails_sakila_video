...
#   Unknown type 'geometry' for column 'location'
  ...
  create_table "category", primary_key: "category_id", id: :integer, limit: 1, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name", limit: 25, null: false
    t.timestamp "last_update", default: -> { "CURRENT_TIMESTAMP" }, null: false
  end

  create_table "city", primary_key: "city_id", id: :integer, limit: 2, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "country", primary_key: "country_id", id: :integer, limit: 2, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "country", limit: 50, null: false
    t.timestamp "last_update", default: -> { "CURRENT_TIMESTAMP" }, null: false
  end

  create_table "customer", primary_key: "customer_id", id: :integer, limit: 2, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "film", primary_key: "film_id", id: :integer, limit: 2, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "film_actor", primary_key: ["actor_id", "film_id"], options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "film_category", primary_key: ["film_id", "category_id"], options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "film_id", limit: 2, null: false, unsigned: true
  ...
  create_table "film_text", primary_key: "film_id", id: :integer, limit: 2, default: nil, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title", null: false
    t.text "description"
    t.index ["title", "description"], name: "idx_title_description", type: :fulltext
  end

  create_table "inventory", primary_key: "inventory_id", id: :integer, limit: 3, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "film_id", limit: 2, null: false, unsigned: true
    t.integer "store_id", limit: 1, null: false, unsigned: true
    t.timestamp "last_update", default: -> { "CURRENT_TIMESTAMP" }, null: false
    t.index ["film_id"], name: "idx_fk_film_id"
  ...
  create_table "language", primary_key: "language_id", id: :integer, limit: 1, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name", limit: 20, null: false
    t.timestamp "last_update", default: -> { "CURRENT_TIMESTAMP" }, null: false
  end

  create_table "payment", primary_key: "payment_id", id: :integer, limit: 2, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "store", primary_key: "store_id", id: :integer, limit: 1, unsigned: true, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
